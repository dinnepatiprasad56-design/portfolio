...
export const PORTFOLIO_DATA = {
  personal: {
    ...
    bio: "Dedicated B.E Computer Science student with an 8.93 CGPA, specializing in Cloud Engineering (FastAPI/Cloud Run/Docker), Android development (Kotlin/Jetpack Compose), and actively expanding into Cybersecurity and Computer Networking technologies.",
    ...
    socialLinks: {
      ...
      resumeUrl: "https://drive.google.com/file/d/129u9_3iuDwxOeGkz7fjFpWrCYVS8hfGT/view?usp=sharing",
      resumeDownloadUrl: "https://drive.google.com/uc?export=download&id=129u9_3iuDwxOeGkz7fjFpWrCYVS8hfGT",
      resumePreviewUrl: "https://drive.google.com/file/d/129u9_3iuDwxOeGkz7fjFpWrCYVS8hfGT/preview",
    },
    quickStats: [
  ...
  education: [
    {
      ...
      highlights: [
        "Top tier academic performance with CGPA of 8.93 / 10.",
